...
draw_text_color(room_width/2 - 32, room_height/2, "Rob/Pleinair/Touchek/vikaster", c_black, c_black, c_black, c_black, 1);

draw_set_font(fnt_normal)
draw_text_color(room_width/2 - 48, room_height - 24, "Dungeon Crawler Gam Jam 2024", c_black, c_black, c_black, c_black, 1)