...
//health bar
var _perc = global.player.confidence.current/global.player.confidence.max;//0.5;
...
draw_sprite_part(spr_health_bar, 0, 0, 0, (_spr_w * _perc), _spr_h, _margin + 2, _margin + 2);